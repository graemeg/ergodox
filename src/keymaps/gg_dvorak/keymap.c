...
/*
  ...
  designed to work well with my programming environment.
 ...
 * ╰─┬──────┼──────┼──────┼──────┼──────┼──────┴──────╯           ╰──────┴──────┼──────┼──────┼──────┼──────┼──────┬─╯
 *   │LCtrl │ LAlt │ Cmd  │Cut/Cp│ Paste│                                       │  ◀   │  ▲   │  ▼   │  ▶   │ RCtrl│
 *   ╰──────┴──────┴──────┴──────┴──────╯                                       ╰──────┴──────┴──────┴──────┴──────╯
 *                                        ╭──────┬──────╮       ╭──────┬──────╮
 *                                        │ Game │ QWER │       │ GUI  │ App  │
 *                                 ╭──────┼──────┼──────┤       ├──────┼──────┼──────╮      Hyper = Meh+Gui
 ...
 */
	...
	KC_LCTRL,	KC_LALT,	KC_LGUI,	M(A_COPYCUT),	PASTE,
 ...
 */
	...
	______,	KC_PLUS,	KC_7,	KC_8,	KC_9,	KC_0,	KC_SLASH,
 ...
 */
	...
	______,	__x___,	KC_MS_BTN4,	KC_MS_BTN5,	__x___,	__x___,	______,
	______,	______,	__x___,	__x___,	__x___,
	______,	______,
	______,
	______,	______,	______,
 ...
 */
	...
	______,	__x___,	KC_PGUP,	__x___,	KC_PGDN,	__x___,	__x___,
			KC_LCTRL,	__x___,	__x___,	__x___,	__x___,
	______,	______,
	______,
	______,	KC_LALT,	LCTL(KC_LSHIFT)
),
 ...
 */
	...
	______,	______,	______,	______,	______,	______,	______,
	______,	______,	______,	______,	KC_U,	______,
	______,	______,	______,	______,	______,	______,	______,
	______,	______,	______,	______,	KC_SPC,
	______,	______,
	______,

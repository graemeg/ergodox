 ...
 *
 * ╭────────┬──────┬──────┬──────┬──────┬──────┬──────╮           ╭──────┬──────┬──────┬──────┬──────┬──────┬────────╮
 * │  Esc   │  F1  │  F2  │  F3  │  F4  │  F5  │  F11 │           │  F12 │  F6  │  F7  │  F8  │  F9  │  F10 │  Home  │
 * ├────────┼──────┼──────┼──────┼──────┼──────┼──────┤           ├──────┼──────┼──────┼──────┼──────┼──────┼────────┤
 * │  Tab   │  '  "│  ,  <│  .  >│  P   │   Y  │ Cut/ │           │ PgUp │   F  │   G  │  C   │  R   │  L   │   End  │
 * ├────────┼──────┼──────┼──────┼──────┼──────┤ Copy │           │      ├──────┼──────┼──────┼──────┼──────┼────────┤
 * │  Caps  │  A   │  O   │  E   │  U • │   I  ├──────┤           ├──────┤   D  │ • H  │  T   │  N   │  S   │  Enter │
 * ├────────┼──────┼──────┼──────┼──────┼──────┤ Paste│           │ PgDn ├──────┼──────┼──────┼──────┼──────┼────────┤
 * │ Shift  │  ;  :│  Q   │  J   │  K   │   X  │      │           │      │   B  │   M  │  W   │  V   │  ▲   │  Shift │
 * ╰─┬──────┼──────┼──────┼──────┼──────┼──────┴──────╯           ╰──────┴──────┼──────┼──────┼──────┼──────┼──────┬─╯
 *   │LCtrl │ LAlt │  :=  │      │ Arrw │                                       │  Del │   Z  │   ◀  │  ▼   │   ▶  │
 *   ╰──────┴──────┴──────┴──────┴──────╯                                       ╰──────┴──────┴──────┴──────┴──────╯
 *                                        ╭──────┬──────╮       ╭──────┬──────╮
 *                                        │ INS  │ SLCK │       │ GUI  │ QWER │
 *                                 ╭──────┼──────┼──────┤       ├──────┼──────┼──────╮      Hyper = Meh+Gui
 *                                 │ Space│ Enter│ App  │       │ Beakl│      │      │        Meh = Control+Alt+Shift
 *                                 │  /   │  /   ├──────┤       ├──────┤ BkSp │ Sym2 │        GUI = Super or Win key
 *                                 │ Ctrl │ Alt  │ PScr │       │ DHome│      │      │        App = Menu key
 *                                 ╰──────┴──────┴──────╯       ╰──────┴──────┴──────╯        OSL = One-Shot Layer
 */
	// left hand
	KC_ESC,	KC_F1,	KC_F2,	KC_F3,	KC_F4,	KC_F5,	KC_F11,
	KC_TAB,	KC_QUOT,	KC_COMM,	KC_DOT,	KC_P,	KC_Y,	M(A_COPYCUT),
	KC_CAPS,	KC_A,	KC_O,	KC_E,	KC_U,	KC_I,
	KC_LSFT,	KC_SCLN,	KC_Q,	KC_J,	KC_K,	KC_X,	PASTE,
	KC_LCTRL,	KC_LALT,	M(MACRO_ISEQUALS),	__x___,	MO(AROWS),
 ...
 */
	...
	______,	SFT_T(KC_A),	CTL_T(KC_O),	ALT_T(KC_E),	LT(AROWS,KC_U),	______,
	______,	______,	______,	______,	______,	______,	______,
 ...
 */
	...
	______,	KC_PGDN,	KC_PGUP,	__x___,	KC_PGDN,	__x___,	__x___,
			KC_LCTRL,	__x___,	__x___,	__x___,	KC_SLCK,
	______,	______,
	______,
	______,	______,	LCTL(KC_LSHIFT)
),
 ...
 */
	...
	______,	KC_N,	KC_M,	KC_COMM,	KC_DOT,	KC_SLSH,	______,
			______,	______,	______,	______,	KC_RCTRL,
 ...
 */
	...
	______,	KC_SLSH,	KC_BSLASH,	KC_LPRN,	KC_LCBR,	KC_LBRACKET,	______,
	______,	______,	______,	______,	______,

	______,	______,
	______,
	KC_LCTRL,	LCTL(LSFT(KC_NO)),	______,

	// right hand
	______,	______,	______,	______,	______,	______,	______,
	______,	KC_CIRC,	KC_AMPR,	KC_ASTR,	KC_MINUS,	KC_EQUAL,	KC_QUES,
		KC_6,	KC_7,	KC_8,	KC_9,	KC_0,	KC_DOT,
	______,	KC_RBRACKET,	KC_RCBR,	KC_RPRN,	KC_UNDS,	KC_PLUS,	KC_PIPE,
	______,	______,	______,	______,	______,
